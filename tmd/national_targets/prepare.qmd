...
It then saves them as ptargets.rds, to be used for further investigation and testing to be sure they seem correct.
...
saveRDS(ptargets, fs::path(QDIR, "data", "potential_targets_preliminary.rds"))

ptargets |>
  write_csv(fs::path(QDIR, "data", "potential_targets_preliminary.csv"))
