# Steps for developing targets for the base year
...
The project produces a [web page](https://boyd-irs-targets.netlify.app/) with a useful datatable in @sec-show-targets [TO COME] that displays the potential targets and allows filtering and sorting to explore the targets.
