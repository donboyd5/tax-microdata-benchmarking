...
def check_url_accessibility(url: str, timeout: int = 30) -> Tuple[bool, str, Optional[Dict]]:
    """
...
def check_streaming_support(url: str, timeout: int = 30) -> Tuple[bool, str]:
    """
...
def check_partial_download(url: str, timeout: int = 30) -> Tuple[bool, str]:
    """
...
def check_full_download_feasibility(url: str, timeout: int = 10) -> Tuple[bool, str]:
    """
...
def check_cps_url(year: int, url: str) -> Dict:
    ...
    accessible, msg, headers = check_url_accessibility(url)
